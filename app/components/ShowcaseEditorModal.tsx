...
export default function ShowcaseEditorModal({ initial, assets, onSave, onClose, onToast, onCopyLink }: Props) {
  ...
  const selectedAssets = useMemo(() => {
    ...
    for (const id of assetIds) {
      ...
      else out.push({ id, headline: "(asset unavailable)", company: "", clientName: "", thumbnail: "", status: "", assetType: "", durationSeconds: null, pullQuote: "", description: "", videoUrl: "", _missing: true });
    }
    return out;
  }, [assetIds, assetMap]);
